...
public class FacturaVentana1 extends javax.swing.JInternalFrame {
     ...
     */
    public FacturaVentana1() throws IOException {
        initComponents();
    ...
    private void jbutonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbutonGuardarActionPerformed
        ...
        JOptionPane.showMessageDialog(this, "Factura registrada correctamente","Atencion",JOptionPane.INFORMATION_MESSAGE);
        }catch(Exception ex){
    ...
    private void jButtonListarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonListarActionPerformed
        try {
            ...
            Logger.getLogger(FacturaVentana1.class.getName()).log(Level.SEVERE, null, ex);
        }
